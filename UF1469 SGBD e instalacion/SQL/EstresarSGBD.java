...
public class EstresarSGBD {
    // Datos de conexión
    private static final String URL = "jdbc:mysql://localhost:3306/bbdd"; //192.168.0.162
            ...
            while (true) {
                ...
                try {
                    ...
                    while ((linea=bufer.readLine())!=null) {
                        ...
                        consulta="INSERT INTO contactos (idcontacto,nombre,edad) VALUES ("+campos[1]+",'"+campos[0]+"',"+campos[1]+")";
